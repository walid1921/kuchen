...
function Datenschutz() {
  return (
    <section className="md:section mb-[100px] lg:px-[270px] md:px-[80px]">
      ...
      <article
        className="post wow animate fadeInUp"
        id="post-3"
        data-wow-delay=".3s"
      >
        <div className="post-content">
          <div className="entry-content">
            <h4 className="wp-block-heading">1. DATENSCHUTZ AUF EINEN BLICK</h4>

            <h5 className="wp-block-heading">Allgemeine Hinweise</h5>
            ...
            <h6 className="wp-block-heading">Wie erfassen wir Ihre Daten?</h6>
            ...
            <h6 className="wp-block-heading">Wofür nutzen wir Ihre Daten?</h6>
            ...
            <h5 className="wp-block-heading">Datenschutz</h5>
            ...
            <p>
              ...
              <br />
              E-Mail:&nbsp;
              <a className="links" href="mailto:info@kuechentrend.com">
            ...
            <p>
              ...
              gerichtlicher Rechtsbehelfe. Eine Liste der
            ...
            <h5 className="wp-block-heading">Recht auf Datenübertragbarkeit</h5>
            ...
            <h5 className="wp-block-heading">SSL- bzw. TLS-Verschlüsselung</h5>
            ...
            <p>
              ...
              ausschließlich über eine verschlüsselte SSL- bzw. TLS-Verbindung.
              Eine verschlüsselte Verbindung erkennen Sie daran, dass die
              Adresszeile des Browsers von „http://“ auf „https://“ wechselt und
              an dem Schloss-Symbol in Ihrer Browserzeile. Bei verschlüsselter
              Kommunikation können Ihre Zahlungsdaten, die Sie an uns
            ...
            <h5 className="wp-block-heading">Widerspruch gegen Werbe-Mails</h5>
            ...
            <h5 className="wp-block-heading">Cookies</h5>
            ...
            <h5 className="wp-block-heading">Server-Log-Dateien</h5>
            ...
            <h5 className="wp-block-heading">Kontaktformular</h5>
            ...
            <p>
              ...
              Ihnen im Kontaktformular eingegebenen Daten verbleiben bei uns,
            ...
            <p>
              ...
              mit der Zahlungsabwicklung beauftragte Kreditinstitut. Eine
              weitergehende Übermittlung der Daten erfolgt nicht bzw. nur dann,
              ...
              etwa zu Zwecken der Werbung, erfolgt nicht. Grundlage für die
            ...
            <p>
              ...
              sich mit Facebook Connect registrieren. Anbieter dieses Dienstes
              ist die Facebook Ireland Limited, 4 Grand Canal Square, Dublin 2,
              Irland.
            </p>

            <p>
              Wenn Sie sich für die Registrierung mit Facebook Connect
              entscheiden und auf den „Login with Facebook“-/„Connect with
              Facebook“-Button klicken, werden Sie automatisch auf die Plattform
              von Facebook weitergeleitet. Dort können Sie sich mit Ihren
              Nutzungsdaten anmelden. Dadurch wird Ihr Facebook-Profil mit
              unserer Website bzw. unseren Diensten verknüpft. Durch diese
              Verknüpfung erhalten wir Zugriff auf Ihre bei Facebook
            ...
            <p>
              ...
              Datenverarbeitungsvorgänge erfolgen auf Grundlage Ihrer
              Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Diese Einwilligung
            ...
            <p>
              ...
              <a
                className="links"
                href="https://de-de.facebook.com/legal/terms/"
                target="_blank"
                rel="noreferrer noopener"
              >
            ...
            <h6 className="wp-block-heading">Speicherung der IP-Adresse</h6>
            ...
            <h6 className="wp-block-heading">Abonnieren von Kommentaren</h6>
            ...
            <p>
              ...
              Newsletterbestellung) an uns übermittelt haben, verbleiben die
              jedoch bei uns.
            </p>

            <h6 className="wp-block-heading">Speicherdauer der Kommentare</h6>

            <p>
              Die Kommentare und die damit verbundenen Daten (z.&nbsp;B.
              IP-Adresse) werden gespeichert und verbleiben auf unserer Website,
            ...
            <h6 className="wp-block-heading">Rechtsgrundlage</h6>
            ...
            <h4 className="wp-block-heading">4. PLUGINS UND TOOLS</h4>

            <h5 className="wp-block-heading">Google Web Fonts</h5>
            ...
            <h5 className="wp-block-heading">Google Maps</h5>
            ...
            <h5 className="wp-block-heading">Adobe Fonts</h5>

            <p>
              Unsere Website nutzt zur einheitlichen Darstellung bestimmter
            ...
            <p>
              Beim Aufruf unserer Seiten lädt Ihr Browser die benötigten
            ...
            <p>
              Adobe verfügt über eine Zertifizierung nach dem
              EU-US-Privacy-Shield. Der Privacy-Shield ist ein Abkommen zwischen
              den Vereinigten Staaten von Amerika und der Europäischen Union,
              das die Einhaltung europäischer Datenschutzstandards gewährleisten
              soll. Nähere Informationen finden Sie unter:&nbsp;
              <a
                className="links"
            ...
            <p>
              Die Nutzung von Adobe Fonts ist erforderlich, um ein einheitliches
              Schriftbild auf unserer Website zu gewährleisten. Dies stellt ein
            ...
            <p>
              ...
              Cookies auf Ihrem Endgerät speichern. Mit Hilfe dieser Cookies
              kann YouTube Informationen über Besucher unserer Website erhalten.
              Diese Informationen werden u. a. verwendet, um Videostatistiken zu
            ...
            <h5 className="wp-block-heading">Vimeo</h5>
            ...
            <h5 className="wp-block-heading">SoundCloud</h5>
            ...
            <p>
              ...
              während Sie in Ihrem SoundCloud- Benutzerkonto eingeloggt sind,
              können Sie die Inhalte unserer Seiten mit Ihrem SoundCloud-Profil
              verlinken und/oder teilen. Dadurch kann SoundCloud Ihrem
              Benutzerkonto den Besuch unserer Seiten zuordnen. Wir weisen
            ...
            <p>
              Die Nutzung von SoundCloud erfolgt auf Grundlage des Art. 6 Abs. 1
              lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse
              an einer möglichst umfangreichen Sichtbarkeit in den Sozialen
              Medien.
            </p>
            ...
            <p>
              ...
              Ihrem SoundCloud- Benutzerkonto zuordnet, loggen Sie sich bitte
              aus Ihrem SoundCloud-Benutzerkonto aus bevor Sie Inhalte des
              SoundCloud-Plugins aktivieren.
            </p>

            <h5 className="wp-block-heading">Spotify</h5>
            ...
            <p>
              ...
              dem grünen Logo auf unserer Seite. Eine Übersicht über die
            ...
            <p>
              Dadurch kann beim Besuch unserer Seiten über das Plugin eine
              ...
              Spotify Button anklicken während Sie in Ihrem Spotify-Account
              eingeloggt sind, können Sie die Inhalte unserer Seiten auf Ihrem
              Spotify Profil verlinken. Dadurch kann Spotify den Besuch unserer
            ...
            <p>
              ...
              der ansprechenden akustischen Ausgestaltung seiner Website.
            </p>
            ...
            <p>
              Wenn Sie nicht wünschen, dass Spotify den Besuch unserer Seiten
              Ihrem Spotify-Nutzerkonto zuordnen kann, loggen Sie sich bitte aus
              Ihrem Spotify-Benutzerkonto aus.
            </p>

            <h5 className="wp-block-heading">Zendesk</h5>

            <p>
              Zur Bearbeitung von Nutzeranfragen verwenden wir das CRM-System
              Zendesk. Anbieter ist die Zendesk, Inc, 1019 Market Street in San
              Francisco, CA 94103 USA.
            </p>

            <p>
              Wir nutzen Zendesk, um Ihre Anfragen schnell und effizient
              bearbeiten zu können. Rechtsgrundlage für die Verarbeitung Ihrer
              Daten ist das berechtigte Interesse auf Grundlage von Art. 6 Abs.
              1 lit. f DSGVO.
            </p>

            <p>
              Zendesk ist als US-amerikanischer Anbieter Privacy-Shield
              zertifiziert und verpflichtet sich dadurch, das Datenschutzrecht
              der EU einzuhalten. Zusätzlich haben wir mit Zendesk einen Vertrag
              über Auftragsverarbeitung (Data Processing Agreement, DPA)
              abgeschlossen. Dadurch ist sichergestellt, dass Zendesk die
              Nutzer-Daten nur im Rahmen der EU-Datenschutznormen ausschließlich
              zur Verarbeitung der Anfragen nutzt und diese nicht an Dritte
              weiter gibt.
            </p>

            <p>
              Sie können Anfragen nur mit Angabe der E-Mail-Adresse und ohne
              Angaben Ihres Namens absenden.
            </p>

            <p>
              Sollten Sie nicht mit der Bearbeitung Ihrer Anfrage bei uns über
              Zendesk einverstanden sein, können Sie alternativ per E-Mail,
              Telefon oder Fax mit uns kommunizieren.
            </p>
            ...
            <h5 className="wp-block-heading">Google reCAPTCHA</h5>

            <p>
              Wir nutzen „Google reCAPTCHA“ (im Folgenden „reCAPTCHA“) auf
              unseren Websites. Anbieter ist die Google Ireland Limited
            ...
            <p>
              ...
              daran, seine Webangebote vor missbräuchlicher automatisierter
            ...
            <h4 className="wp-block-heading">5. SOZIALE MEDIEN</h4>
            ...
            <p>
              Auf unseren Seiten werden Plugins von sozialen Medien verwendet
              (z.&nbsp;B. Facebook, Twitter, Google+, Instagram, Pinterest,
              XING, LinkedIn, Tumblr).
            </p>

            <p>
              Die Plugins können Sie in der Regel anhand der jeweiligen
              Social-Media-Logos erkennen. Um den Datenschutz auf unserer
              Website zu gewährleisten, verwenden wir diese Plugins nur zusammen
              mit der sogenannten „Shariff“-Lösung. Diese Anwendung verhindert,
              dass die auf unserer Website integrierten Plugins Daten schon beim
              ersten Betreten der Seite an den jeweiligen Anbieter übertragen.
            </p>
            ...
            <p>
              ...
              aus Ihrem Facebook-Benutzerkonto aus. Die Verwendung der Facebook
            ...
            <h5 className="wp-block-heading">Einsatz von juicer.io</h5>
            ...
            <p>
              ...
              &nbsp;zum Anzeigen diverser Posts aus Social media Portalen.
              Juicer selbst sammelt keine persönlichen Daten der Besucher die
              diesen Feed besuchen. Details können Sie in der Privacy Policy von
              Juicer nachlesen:&nbsp;
              <a
                className="links"
            ...
            <h5 className="wp-block-heading">Twitter Plugin</h5>
            ...
            <p>
              ...
              die von Ihnen besuchten Websites mit Ihrem Twitter-Account
            ...
            <p>
              ...
              Sozialen Medien. Ihre Datenschutzeinstellungen bei Twitter können
            ...
            <h5 className="wp-block-heading">Google+ Plugin</h5>
            ...
            <p>
              ...
              für das Profil gewählten Namen enthalten muss. Dieser Name wird in
            ...
            <p>
              ...
              verbundene Websites. Die Verwendung des Google+-Plugins erfolgt
              auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber
              hat ein berechtigtes Interesse an einer möglichst umfangreichen
              Sichtbarkeit in den Sozialen Medien.
            </p>

            <h5 className="wp-block-heading">Instagram Plugin</h5>
            ...
            <p>
              Die Verwendung des Instagram-Plugins erfolgt auf Grundlage von
            ...
            <h5 className="wp-block-heading">Tumblr Plugin</h5>

            <p>
              Unsere Seiten nutzen Schaltflächen des Dienstes Tumblr. Anbieter
            ...
            <p>
              Die Verwendung des Tumblr-Plugins erfolgt auf Grundlage von Art. 6
            ...
            <h5 className="wp-block-heading">LinkedIn Plugin</h5>

            <p>
              Unsere Website nutzt Funktionen des Netzwerks LinkedIn. Anbieter
              ist die LinkedIn Corporation, 2029 Stierlin Court, Mountain View,
              CA 94043, USA.
            </p>
            ...
            <p>
              ...
              LinkedIn wird darüber informiert, dass Sie unsere Internetseiten
              ...
              auf unserer Internetseite Ihnen und Ihrem Benutzerkonto
            ...
            <h5 className="wp-block-heading">XING Plugin</h5>

            <p>
              Unsere Website nutzt Funktionen des Netzwerks XING. Anbieter ist
            ...
            <p>
              Die Verwendung des XING-Plugins erfolgt auf Grundlage von Art. 6
              Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes
              Interesse an einer möglichst umfangreichen Sichtbarkeit in den
              Sozialen Medien.
            </p>
            ...
            <p>
              Die Verwendung des Pinterest-Plugins erfolgt auf Grundlage von
              Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein
              berechtigtes Interesse an einer möglichst umfangreichen
              Sichtbarkeit in den Sozialen Medien.
            </p>
            ...
            <h4 className="wp-block-heading">6. ANALYSE TOOLS UND WERBUNG</h4>

            <h5 className="wp-block-heading">Hotjar</h5>
            ...
            <p>
              ...
              feststellen, ob unsere Website mit einem bestimmten Endgerät
              besucht wurde oder ob die Funktionen von Hotjar für den
              betreffenden Browser deaktiviert wurde. Hotjar-Cookies verbleiben
            ...
            <h6 className="wp-block-heading">Deaktivieren von Hotjar</h6>
            ...
            <p>
              ...
              geschlossen, um die strengen europäischen Datenschutzvorschriften
              umzusetzen.
            </p>

            <h5 className="wp-block-heading">Google Analytics</h5>
            ...
            <h6 className="wp-block-heading">IP-Anonymisierung</h6>
            ...
            <h6 className="wp-block-heading">Browser Plugin</h6>
            ...
            <p>
              ...
              <a className="links" href="javascript:gaOptout();">
            ...
            <h6 className="wp-block-heading">Auftragsverarbeitung</h6>
            ...
            <h6 className="wp-block-heading">Speicherdauer</h6>
            ...
            <h5 className="wp-block-heading">Google Analytics Remarketing</h5>

            <p>
              Unsere Websites nutzen die Funktionen von Google Analytics
              Remarketing in Verbindung mit den geräteübergreifenden Funktionen
            ...
            <p>
              ...
              erstellten Werbe-Zielgruppen mit den geräteübergreifenden
              Funktionen von Google AdWords und Google DoubleClick zu
              verknüpfen. Auf diese Weise können interessenbezogene,
              personalisierte Werbebotschaften, die in Abhängigkeit Ihres
              früheren Nutzungs- und Surfverhaltens auf einem Endgerät
              (z.&nbsp;B. Handy) an Sie angepasst wurden auch auf einem anderen
              Ihrer Endgeräte (z.&nbsp;B. Tablet oder PC) angezeigt werden.
            </p>

            <p>
              Haben Sie eine entsprechende Einwilligung erteilt, verknüpft
              Google zu diesem Zweck Ihren Web- und App-Browserverlauf mit Ihrem
              Google-Konto. Auf diese Weise können auf jedem Endgerät auf dem
              Sie sich mit Ihrem Google-Konto anmelden, dieselben
            ...
            <p>
              ...
              unseren Google-Analytics-Daten verknüpft werden, um Zielgruppen
              für die geräteübergreifende Anzeigenwerbung zu definieren und zu
              erstellen.
            </p>
            ...
            <p>
              ...
              <a
                className="links"
                href="https://adssettings.google.com/anonymous?hl=de"
                target="_blank"
                rel="noreferrer noopener"
              >
            ...
            <p>
              ...
              erfolgt ausschließlich auf Grundlage Ihrer Einwilligung, die Sie
              bei Google abgeben oder widerrufen können (Art. 6 Abs. 1 lit. a
              DSGVO). Bei Datenerfassungsvorgängen, die nicht in Ihrem
              Google-Konto zusammengeführt werden (z.&nbsp;B. weil Sie kein
              Google-Konto haben oder der Zusammenführung widersprochen haben)
              beruht die Erfassung der Daten auf Art. 6 Abs. 1 lit. f DSGVO. Das
              berechtigte Interesse ergibt sich daraus, dass der
            ...
            <h5 className="wp-block-heading">Google AdSense</h5>

            <p>
              Diese Website benutzt Google AdSense, einen Dienst zum Einbinden
              von Werbeanzeigen der Google Inc. (&#8222;Google&#8220;). Anbieter
              ist die Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA
              94043, USA. Google AdSense verwendet sogenannte
              ...
              zusammenführen. Die Speicherung von AdSense-Cookies erfolgt auf
              Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
              ein berechtigtes Interesse an der Analyse des Nutzerverhaltens, um
              sowohl sein Webangebot als auch seine Werbung zu optimieren. Sie
            ...
            <p>
              ...
              Tracking-Tools erfolgen auf Grundlage von Art. 6 Abs. 1 lit. f
              DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der
              Analyse des Nutzerverhaltens, um sowohl sein Webangebot als auch
            ...
            <h5 className="wp-block-heading">IONOS WebAnalytics</h5>
            ...
            <ul>
              ...
              <li>
                ...
                sodass sie nicht zu einzelnen Personen zurückverfolgt werden
            ...
            <h5 className="wp-block-heading">WordPress Stats</h5>
            ...
            <p>
              ...
              gespeichert werden und die eine Analyse der Benutzung der Website
              erlauben. Die durch die Cookies generierten Informationen über die
              Benutzung unserer Website werden auf Servern in den USA
              gespeichert. Ihre IP-Adresse wird nach der Verarbeitung und vor
              der Speicherung anonymisiert.
            </p>

            <p>
              „WordPress-Stats“-Cookies verbleiben auf Ihrem Endgerät, bis Sie
              sie löschen. Die Speicherung von „WordPress Stats“-Cookies und die
              Nutzung dieses Analyse-Tools erfolgen auf Grundlage von Art. 6
              Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes
            ...
            <p>
              ...
              generell ausschließen sowie das automatische Löschen der Cookies
              beim Schließen des Browser aktivieren. Bei der Deaktivierung von
              Cookies kann die Funktionalität unserer Website eingeschränkt
              sein.
            </p>
            ...
            <h5 className="wp-block-heading">Facebook Pixel</h5>
            ...
            <h4 className="wp-block-heading">7. NEWSLETTER</h4>
            ...
            <h4 className="wp-block-heading">8. EIGENE DIENSTE</h4>

            <h5 className="wp-block-heading">Bewerbungen</h5>

            <p>
              Wir bieten Ihnen die Möglichkeit, sich bei uns zu bewerben
              (z.&nbsp;B. per E-Mail, postalisch oder via
              Online-Bewerberformular). Im Folgenden informieren wir Sie über
              Umfang, Zweck und Verwendung Ihrer im Rahmen des
            ...
            <h6 className="wp-block-heading">Aufbewahrungsdauer der Daten</h6>

            <p>
              Wenn wir Ihnen kein Stellenangebot machen können, Sie ein
              Stellenangebot ablehnen, Ihre Bewerbung zurückziehen, Ihre
              Einwilligung zur Datenverarbeitung widerrufen oder uns zur
              Löschung der Daten auffordern, werden die von Ihnen übermittelten
              Daten inkl. ggf. verbleibender physischer Bewerbungsunterlagen für
              maximal 6 Monate nach Abschluss des Bewerbungsverfahrens
              gespeichert bzw. aufbewahrt (Aufbewahrungsfrist), um die
              Einzelheiten des Bewerbungsprozesses im Falle von Unstimmigkeiten
              nachvollziehen zu können (Art. 6 Abs. 1 lit. f DSGVO).
            </p>

            <p>
              DIESER SPEICHERUNG KÖNNEN SIE WIDERSPRECHEN, SOFERN IHRERSEITS
              BERECHTIGTE INTERESSEN VORLIEGEN, DIE UNSERE INTERESSEN
              ÜBERWIEGEN.
            </p>

            <p>
              Nach Ablauf der Aufbewahrungsfrist werden die Daten gelöscht,
              sofern keine gesetzliche Aufbewahrungspflicht oder ein sonstiger
              Rechtsgrund zur weiteren Speicherung vorliegt. Sofern ersichtlich
              ist, dass die Aufbewahrung Ihrer Daten nach Ablauf der
              Aufbewahrungsfrist erforderlich sein wird (z.&nbsp;B. aufgrund
            ...
            <h5 className="wp-block-heading">Amazon Partnerprogramm</h5>

            <p>
              Die Betreiber der Seiten nehmen am Amazon EU- Partnerprogramm
              teil. Auf unseren Seiten werden durch Amazon Werbeanzeigen und
              Links zur Seite von Amazon.de eingebunden, an denen wir über 23 /
              27 Werbekostenerstattung Geld verdienen können. Amazon setzt dazu
              Cookies ein, um die Herkunft der Bestellungen nachvollziehen zu
              können. Dadurch kann Amazon erkennen, dass Sie den Partnerlink auf
              unserer Website geklickt haben. Die Speicherung von
              „Amazon-Cookies“ erfolgt auf Grundlage von Art. 6 lit. f DSGVO.
              Der Websitebetreiber hat hieran ein berechtigtes Interesse, da nur
              durch die Cookies die Höhe seiner Affiliate-Vergütung feststellbar
              ist. Weitere Informationen zur Datennutzung durch Amazon erhalten
            ...
            <h5 className="wp-block-heading">PayPal</h5>

            <p>
              Auf unserer Website bieten wir u.a. die Bezahlung via PayPal an.
              Anbieter dieses Zahlungsdienstes ist die PayPal (Europe) S.à.r.l.
            ...
            <p>
              ...
              Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) und Art. 6 Abs. 1 lit. b
            ...
            <h5 className="wp-block-heading">Klarna</h5>

            <p>
              Auf unserer Website bieten wir u.a. die Bezahlung mit den Diensten
              von Klarna an. Anbieter ist die Klarna AB, Sveavägen 46, 111 34
              Stockholm, Schweden (im Folgenden „Klarna“).
            </p>

            <p>
              Klarna bietet verschiedene Zahlungsoptionen an (z.&nbsp;B.
              Ratenkauf). Wenn Sie sich für die Bezahlung mit Klarna entscheiden
              (Klarna-Checkout-Lösung), wird Klarna verschiedene
              personenbezogene Daten von Ihnen erheben. Details hierzu können
              Sie in der Datenschutzerklärung von Klarna unter folgendem Link
              nachlesen:&nbsp;
              <a
                className="links"
            ...
            <p>
              ...
              zu optimieren. Die Optimierung der Checkout-Lösung stellt ein
              berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO
              dar. Cookies sind kleine Textdateien, die auf Ihrem Endgerät
              gespeichert werden und keinen Schaden anrichten. Sie verbleiben
              auf Ihrem Endgerät bis Sie sie löschen. Details zum Einsatz von
            ...
            <h5 className="wp-block-heading">Sofortüberweisung</h5>
            ...
            <p>
              ...
              Echtzeit eine Zahlungsbestätigung von der Sofort GmbH und können
            ...
            <p>
              ...
              übermittelt. Bei den Daten zu Ihrer Person handelt es sich um Vor-
              und Nachname, Adresse, Telefonnummer(n), Email-Adresse, IP-Adresse
              und ggf. weitere zur Zahlungsabwicklung erforderliche Daten. Die
            ...
            <p>
              ...
              Grundlage von Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) und Art. 6
              ...
              jederzeit zu widerrufen. Ein Widerruf wirkt sich auf die
            ...
            <h5 className="wp-block-heading">Paydirekt</h5>

            <p>
              Auf unserer Website bieten wir u.a. die Bezahlung mittels
              Paydirekt an. Anbieter dieses Zahlungsdienstes ist die Paydirekt
              GmbH, Hamburger Allee 26-28, 60486 Frankfurt am Main, Deutschland
              (im Folgenden „Paydirekt“).
            </p>

            <p>
              Wenn Sie die Bezahlung mittels Paydirekt ausführen, erhebt
              Paydirekt verschiedene Transaktionsdaten und leitet diese an die
              Bank weiter, bei der Sie mit Paydirekt registriert sind. Neben den
              für die Zahlung erforderlichen Daten erhebt Paydirekt im Rahmen
              der Transaktionsabwicklung ggf. weitere Daten wie z.&nbsp;B.
              Lieferadresse oder einzelne Positionen im Warenkorb.
            </p>

            <p>
              Paydirekt authentifiziert die Transaktion anschließend mit Hilfe
              des bei der Bank hierfür hinterlegten
              Authentifizierungsverfahrens. Anschließend wird der Zahlbetrag von
              Ihrem Konto auf unser Konto überwiesen. Weder wir noch Dritte
              haben Zugriff auf Ihre Kontodaten.
            </p>
            ...
            <p>
              Soziale Netzwerke wie Facebook, Google+ etc. können Ihr
              Nutzerverhalten in der Regel umfassend analysieren, wenn Sie deren
              Webseite oder eine Webseite mit integrierten Social-Media-Inhalten
              (z.&nbsp;B. Like-Buttons oder Werbebannern) besuchen. Durch den
              Besuch unserer Social-Media-Präsenzen werden zahlreiche
              datenschutzrelevante Verarbeitungsvorgänge ausgelöst. Im
              Einzelnen:
            </p>
            ...
            <p>
              ...
              Social-Media-Präsenz angezeigt werden. Sofern Sie über einen
              Account beim jeweiligen sozialen Netzwerk verfügen, kann die
            ...
            <p>
              ...
              berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO.
              Die von den sozialen Netzwerken initiierten Analyseprozesse
              beruhen ggf. auf abweichenden Rechtsgrundlagen, die von den
              Betreibern der sozialen Netzwerke anzugeben sind (z.&nbsp;B.
              Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO).
            </p>

            <p>
              <strong>Verantwortlicher und Geltendmachung von Rechten</strong>
              <br />
              ...
              als auch ggü. dem Betreiber des jeweiligen Social-Media-Portals
            ...
            <p>
              ...
              Einwilligung zur Speicherung widerrufen oder der Zweck für die
              Datenspeicherung entfällt. Gespeicherte Cookies verbleiben auf
            ...
            <p>
              ...
              sozialen Netzwerke zu eigenen Zwecken gespeichert werden, haben
              wir keinen Einfluss. Für Einzelheiten dazu informieren Sie sich
              bitte direkt bei den Betreibern der sozialen Netzwerke (z.&nbsp;B.
              in deren Datenschutzerklärung, siehe unten).
            </p>

            <h5 className="wp-block-heading">Soziale Netzwerke im Einzelnen</h5>

            <h5 className="wp-block-heading">Facebook</h5>

            <p>
              Wir verfügen über ein Profil bei Facebook. Anbieter ist die
              Facebook Inc., 1 Hacker Way, Menlo Park, California 94025, USA.
              Facebook verfügt über eine Zertifizierung nach dem
            ...
            <p>
              ...
              Vereinbarung wird festgelegt, für welche
              Datenverarbeitungsvorgänge wir bzw. Facebook verantwortlich ist,
              wenn Sie unsere Facebook-Page besuchen. Diese Vereinbarung können
            ...
            <h6 className="wp-block-heading">
              Facebook-Fanpage Insights &#8211; Hinweis für unsere
              Facebook-Fanpage Nutzer
            </h6>

            <p>
              Facebook Ireland Ltd („Facebook“) stellt uns als Facebook-Fanpage
              Betreiber sog. „Facebook-Insights“ („Insights“) zur Verfügung. Bei
              den Insights handelt es sich um verschiedene Statistiken, die uns
              Aufschluss über die Verwendung unserer Facebook-Fanpage geben.
              Detaillierte Informationen hierzu und welche Datenverarbeitung
              stattfindet, finden Sie unter&nbsp;
              <a
                className="links"
                href="https://www.facebook.com/business/a/page/page-insights"
                target="_blank"
                rel="noreferrer noopener"
              >
            ...
            <p>
              Facebook-Fanpage-Insights können auf personenbezogenen Daten
              basieren, die im Zusammenhang mit einem Besuch oder einer
              Interaktion von Personen auf bzw. mit unserer Facebook-Fanpage und
              ihren Inhalten erfasst wurden, so dass auch personenbezogene Daten
              durch Facebook verarbeitet werden können, besuchen Sie unsere
              Facebook-Site. Die wesentlichen Informationen der zwischen uns und
              Facebook geschlossenen Vereinbarung im Sinne von Artikel 26
              Datenschutz-Grundverordnung finden Sie dort:&nbsp;
              <a
                className="links"
                href="https://www.facebook.com/legal/terms/page_controller_addendum"
                target="_blank"
            ...
            <p>
              <strong>Gemeinsam für die Verarbeitung verantwortlich</strong>
            ...
            <p>
              ...
              <br />
              E-Mail:{" "}
              <a className="links" href="mailto:info@kuechentrend-kayu.de">
                info@kuechentrend-kayu.de
              </a>
            </p>
            ...
            <ul>
              <li>
                die Informationspflichten aus Artikeln 12, 13 DSGVO, ebenso
              </li>
              <li>
                die Verpflichtungen aus Artikel 15 bis 21 DSGVO, die
                Betroffenenrechte können also gegenüber Facebook Ireland geltend
            ...
            <p>
              Selbstverständlich können Sie Ihre Rechte aber auch uns gegenüber
              geltend machen.
            </p>

            <p>
              Facebook Ireland trifft im Einklang mit Artikel 32 DSGVO geeignete
              technische und organisatorische Maßnahmen, um die Sicherheit der
              Verarbeitungen mittels Facebook Fanpage Insights zu gewährleisten.
            </p>

            <p>
              Rechtsgrundlage und Zwecke der Verarbeitung seitens Facebook
              Ireland entnehmen Sie bitte den dortigen Angaben:&nbsp;
              <a
                className="links"
                href="https://www.facebook.com/about/privacy/legal_bases"
                target="_blank"
                rel="noreferrer noopener"
              >
            ...
            <p>
              Wir verarbeiten die Facebook Fanpage Insights Daten aufgrund
              unseres berechtigen Interesse zur Auswertungen der Aktivitäten auf
              unserer Fanpage und unserer Marketingmaßnahmen dort
              (Werbeanzeigen, -Kampagnen, -Postings); Artikel 6 Absatz 1 Satz 1
              f) DSGVO.
            </p>
            ...
            <p>
              ...
              <a
                ...
                rel="noreferrer noopener"
              >
                Facebook Fanpages und InSights &#8211; hier die Antworten
              </a>
            </p>

            <p>
              Sie sind gesetzlich nicht verpflichtet, Ihre personenbezogenen
              Daten bereitzustellen. Die Bereitstellung kann jedoch für einen
              Vertragsabschluss oder für Funktionen der Facebook Fanpage
              erforderlich sein. Bei einer Nichtbereitstellung kann also
              gegebenenfalls ein Vertrag oder eine Funktion auf der Facebook
              Fanpage nicht angeboten werden.
            </p>

            <p>
              Die Rechte von betroffenen Personen ergeben sich insbesondere aus
              Artikel 15 bis 23 und Artikel 77 Datenschutzgrundverordnung sowie
              aus §§ 32 bis 37 Bundesdatenschutzgesetz.
            </p>

            <p>
              Sie haben im Hinblick auf Ihre personenbezogenen Daten das Recht
              auf
            </p>
            ...
            <p>
              Sie haben ferner das Recht, gegen die Verarbeitung von
            ...
            <p>
              Wenn Sie eine Einwilligung zur Verarbeitung von personenbezogenen
              Daten erteilt haben, haben Sie das Recht des
            </p>
            ...
            <p>
              Alle Anfragen, Aufforderungen und Mitteilungen richten Sie bitte
              an Facebook Ireland oder an uns, siehe oben-
            </p>
            ...
            <p>
              bei der zuständigen Aufsichtsbehörde, vgl. Artikel 77
              Datenschutzgrundverordnung. Unbeschadet eines anderweitigen
              verwaltungsrechtlichen oder gerichtlichen Rechtsbehelfs steht
              Ihnen dieses Recht auf Beschwerde bei einer Aufsichtsbehörde,
              ...
              verstößt. Die für Facebook Ireland zuständige Aufsichtsbehörde ist
              ...
              ) für uns ist zuständig die Landesbeauftragte für Datenschutz und
            ...
            <p>
              1. Sie haben das Recht aus Gründen, die sich aus Ihrer besonderen
              Situation ergeben, jederzeit gegen die Verarbeitung Sie
              betreffender personenbezogener Daten Widerspruch einzulegen, die
              aufgrund von Artikel 6 Absatz 1 Satz 1 f)
              Datenschutzgrundverordnung (Datenverarbeitung auf der Grundlage
            ...
            <p>
              2. In Einzelfällen verarbeiten wir personenbezogene Daten, um
              Direktwerbung zu betreiben. Ist dies bei Ihnen der Fall, haben Sie
              das Recht, jederzeit Widerspruch gegen die Verarbeitung Sie
              betreffender Daten zum Zwecke derartiger Werbung einzulegen
            </p>

            <p>
              Widersprechen Sie der Verarbeitung für Zwecke der Direktwerbung,
              so werden wir Ihre personenbezogenen Daten nicht mehr für diese
              Zwecke verarbeiten.
            </p>

            <p>Der Widerspruch kann formfrei erfolgen.</p>

            <h5 className="wp-block-heading">Google+</h5>

            <p>
              Wir verfügen über ein Profil bei Google+. Anbieter ist die Google
              Ireland Limited („Google“), Gordon House, Barrow Street, Dublin 4,
              Irland. Google verfügt über eine Zertifizierung nach dem
              EU-US-Privacy-Shield:
            </p>
            ...
            <h5 className="wp-block-heading">Twitter</h5>

            <p>
              Wir nutzen den Kurznachrichtendienst Twitter. Anbieter ist die
              Twitter Inc., 1355 Market Street, Suite 900, San Francisco, CA
              94103, USA. Twitter verfügt über eine Zertifizierung nach dem
              EU-US-Privacy-Shield.
            </p>

            <p>
              <strong>
                Sie können Ihre Twitter-Datenschutzeinstellungen selbstständig
                in Ihrem Nutzer-Account anpassen. Klicken Sie hierzu auf
            ...
            <h5 className="wp-block-heading">Instagram</h5>
            ...
            <h5 className="wp-block-heading">Pinterest</h5>

            <p>
              Wir verfügen über ein Profil bei Pinterest. Betreiber ist die
              Pinterest Inc., 808 Brannan Street San Francisco, CA 94103-490,
              USA („Pinterest“). Details zu deren Umgang mit Ihren
            ...
            <h5 className="wp-block-heading">XING</h5>

            <p>
              Wir verfügen über ein Profil bei XING. Anbieter ist die XING AG,
              Dammtorstraße 29-32, 20354 Hamburg, Deutschland. Details zu deren
            ...
            <h5 className="wp-block-heading">LinkedIn</h5>

            <p>
              Wir verfügen über ein Profil bei LinkedIn. Anbieter ist die
              LinkedIn Ireland Unlimited Company<strong>,&nbsp;</strong>Wilton
              Plaza, Wilton Place, Dublin 2,&nbsp;Irland. LinkedIn verfügt über
              eine Zertifizierung nach dem EU-US-Privacy-Shield. LinkedIn
              verwendet Werbecookies.
            </p>

            <p>
              <strong>
                Wenn Sie LinkedIn-Werbe-Cookies deaktivieren möchten, nutzen Sie
            ...
            <p>
              Details zu deren Umgang mit Ihren personenbezogenen Daten
              entnehmen Sie der Datenschutzerklärung von LinkedIn:&nbsp;
              <a
                className="links"
                href="https://www.linkedin.com/legal/privacy-policy"
                target="_blank"
            ...
            <h5 className="wp-block-heading">Tumblr</h5>

            <p>
              Wir verfügen über ein Profil bei Tumblr. Anbieter ist die Tumblr,
              Inc., 35 East 21st St, 10th Floor, New York, NY 10010, USA.
              Details zu deren Umgang mit Ihren personenbezogenen Daten
              entnehmen Sie der Datenschutzerklärung von Tumblr:&nbsp;
              <a
                className="links"
                href="https://www.tumblr.com/privacy/de"
                target="_blank"
