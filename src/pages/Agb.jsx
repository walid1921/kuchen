      ...
      <div className="flex flex-col space-y-8">
        <div className="flex flex-col gap-10">
          ...
          <p className="t text-justify">
            ...
            Eigentum des Verkäufers. Der Käufer hat die unter Eigentumsvorbehalt
            stehenden Waren pfleglich zu behandeln. Jeder Standortwechsel und
            Eingriffe Dritter, insbesondere Pfändungen, sind dem Verkäufer
            unverzüglich mitzuteilen, bei Pfändungen unter Beifügung des
            Pfändungsprotokolls.
          </p>
          ...
          <p className="t text-justify">
            ...
            anderweitige Vereinbarung erfolgt ist. Handelsübliche und zumutbare
          ...
          <p className="t text-justify">
            ...
            oder im Falle kalendermäßig bestimmter Lieferfrist mit deren Ablauf
            – zu gewähren. Liefert der Verkäufer bis zum Ablauf der gesetzten
            ...
            innerhalb einer zu setzenden angemessenen Nachfrist nach Eingang des
            Mahnschreibens des Käufers beim Verkäufer an den Käufer erfolgt. Die
            gesetzlichen Bestimmungen in Bezug auf Schadenersatz wegen
            Nichterfüllung bleiben unberührt.
            <br />
            Soweit nur Einzelelemente der Küche bzw. des Gesamtauftrags von der
            verspäteten Lieferung betroffen sind, besteht das Rücktrittsrecht
            nur insoweit.
          </p>
          ...
          <p className="t text-justify">
            ...
            Käufer hat die Möglichkeit, die neuen Masse dem Verkäufer
            schriftlich mitzuteilen oder den Verkäufer zur erneuten Aufmaßnahme
            einzubestellen.
            <br />
          ...
          <p className="t text-justify">
            ...
            unberechtigt nicht nachkommt oder sich diesen Pflichten unberechtigt
            verweigert oder die Erfüllung dieser Pflichten sonst wie
            unberechtigt verhindert, ist der Verkäufer berechtigt, nach
            vorheriger schriftlicher Mahnung und angemessener Fristsetzung, 30 %
            des Bestellpreises als pauschalen Schadenersatz wegen Nichterfüllung
            zu verlangen. Dem Käufer bleibt der Nachweis unbenommen, dass dem
            Verkäufer kein oder ein geringerer Schaden entstanden ist.
          ...
          <p className="t text-justify">
            ...
            Vermögen ein Insolvenz- oder Vergleichsverfahren beantragt wurde, es
            sei denn, der Käufer leistet unverzüglich Vorauskasse oder
          ...
          <p className="t text-justify">
            ...
            Fahrlässigkeit ausgeschlossen, soweit davon nicht Schäden an Leben,
            Körper oder Gesundheit betroffen sind.
            <br />
          </p>
          ...
          <p className="t text-justify">
            ...
            der Rechnung spätestens 30 Tage nach Rechnungsdatum fällig. Leistet
            der Käufer nicht fristgemäß, kommt er ohne eine weitere Mahnung des
          ...
          <p className="t text-justify">
            ...
            Firma des Verkäufers ausschließlicher Gerichtsstand. Wenn der Käufer
